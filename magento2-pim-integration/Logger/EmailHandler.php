...
class EmailHandler extends \Monolog\Handler\MailHandler
{
    ...
    public function __construct(
        ...
        $threshold = $scopeConfig->getValue('pim/email_alerts/threshold');
    ...
    {
        $recipients = $this->scopeConfig->getValue('pim/email_alerts/recipients');
        ...
        try {
            $transport = $this->transportBuilder
                ->setTemplateIdentifier('pim_notification_template')
                ->setTemplateOptions(
                    [
